...
import icon2 from "../../../Images/s5/s5-icon2.png";
import icon3 from "../../../Images/s5/s5-icon3.png";
import icon4 from "../../../Images/s5/s5-icon4.png";
import icon5 from "../../../Images/s5/s5-icon5.png";
import icon6 from "../../../Images/s5/s5-icon6.png";
import icon7 from "../../../Images/s5/s5-icon7.png";
import icon8 from "../../../Images/s5/s5-icon8.png";
      ...
      <div className="s5-mainContaier">
        <div className="s5-headContainer">
          ...
          <div className="s5-heading2">
            ...
            queries. Our medical panel consists
        ...
        <div className="s5-gridContainer">
          <div className="s5-gridDiv1">
            ...
            <div className="s5-gridDiv1-text">
              <div className="s5-gridDiv1-Text1">Addiction</div>
            </div>
          </div>
          <div className="s5-gridDiv1">
            <div className="s5-gridDiv1-icon">
            ...
            <div className="s5-gridDiv1-text">
              <div className="s5-gridDiv1-Text1">Adolescent</div>
            </div>
          </div>
          <div className="s5-gridDiv1">
            <div className="s5-gridDiv1-icon">
            ...
            <div className="s5-gridDiv1-text">
              <div className="s5-gridDiv1-Text1">Forensic</div>
            </div>
          </div>
          <div className="s5-gridDiv1">
            <div className="s5-gridDiv1-icon">
            ...
            <div className="s5-gridDiv1-text">
              <div className="s5-gridDiv1-Text1">Geriatric</div>
            </div>
          </div>
          <div className="s5-gridDiv1">
            <div className="s5-gridDiv1-icon">
            ...
            <div className="s5-gridDiv1-text">
              <div className="s5-gridDiv1-Text1">Neuropsychiatry</div>
            </div>
          </div>
          <div className="s5-gridDiv1">
            <div className="s5-gridDiv1-icon">
          ...
          <div className="s5-gridDiv1">
            ...
            <div className="s5-gridDiv1-text">
              <div className="s5-gridDiv1-Text1">Psychosomatic</div>
            </div>
          </div>
          <div className="s5-gridDiv1">
            <div className="s5-gridDiv1-icon">
            ...
            <div className="s5-gridDiv1-text">
              <div className="s5-gridDiv1-Text1">Cross-cultural</div>
            </div>
          </div>
        </div>
      </div>
